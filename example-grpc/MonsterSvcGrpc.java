//Generated by flatc compiler (version 1.8.0) on Dec 11 2017 00:40:58  
//If you make any local changes, they will be lost
//source: monster-service.fbs
...
@javax.annotation.Generated(
    ...
    comments = "Source: monster-service.fbs")
public final class MonsterSvcGrpc {

  private MonsterSvcGrpc() {}
  
  public static final String SERVICE_NAME = "example.MonsterSvc";
  
  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getShowMonsterMethod()} instead. 
  public static final io.grpc.MethodDescriptor<example.MonsterRequest,
      example.Monster> METHOD_SHOW_MONSTER = getShowMonsterMethod();
  
  private static volatile io.grpc.MethodDescriptor<example.MonsterRequest,
      example.Monster> getShowMonsterMethod;
  
  
  private static volatile FlatbuffersUtils.FBExtactor<example.MonsterRequest> extractorOfMonsterRequest;
  private static FlatbuffersUtils.FBExtactor<example.MonsterRequest> getExtractorOfMonsterRequest() {
      if (extractorOfMonsterRequest != null) return extractorOfMonsterRequest;
      synchronized (MonsterSvcGrpc.class) {
          if (extractorOfMonsterRequest != null) return extractorOfMonsterRequest;
          extractorOfMonsterRequest = new FlatbuffersUtils.FBExtactor<example.MonsterRequest>() {
              public example.MonsterRequest extract (ByteBuffer buffer) {
                  return example.MonsterRequest.getRootAsMonsterRequest(buffer);
              }
          };
  ...
  private static volatile FlatbuffersUtils.FBExtactor<example.Monster> extractorOfMonster;
  private static FlatbuffersUtils.FBExtactor<example.Monster> getExtractorOfMonster() {
      if (extractorOfMonster != null) return extractorOfMonster;
      synchronized (MonsterSvcGrpc.class) {
          if (extractorOfMonster != null) return extractorOfMonster;
          extractorOfMonster = new FlatbuffersUtils.FBExtactor<example.Monster>() {
              public example.Monster extract (ByteBuffer buffer) {
                  return example.Monster.getRootAsMonster(buffer);
              }
          };
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<example.MonsterRequest,
      example.Monster> getShowMonsterMethod() {
    io.grpc.MethodDescriptor<example.MonsterRequest, example.Monster> getShowMonsterMethod;
    if ((getShowMonsterMethod = MonsterSvcGrpc.getShowMonsterMethod) == null) {
      synchronized (MonsterSvcGrpc.class) {
        if ((getShowMonsterMethod = MonsterSvcGrpc.getShowMonsterMethod) == null) {
          MonsterSvcGrpc.getShowMonsterMethod = getShowMonsterMethod = 
              io.grpc.MethodDescriptor.<example.MonsterRequest, example.Monster>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "example.MonsterSvc", "ShowMonster"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(FlatbuffersUtils.marshaller(
                  example.MonsterRequest.class, getExtractorOfMonsterRequest()))
              .setResponseMarshaller(FlatbuffersUtils.marshaller(
                  example.Monster.class, getExtractorOfMonster()))
  ...
  public static abstract class MonsterSvcImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public     void showMonster(example.MonsterRequest request,
        io.grpc.stub.StreamObserver<example.Monster> responseObserver)     {
  ...
  public static final class MonsterSvcBlockingStub extends io.grpc.stub.AbstractStub<MonsterSvcBlockingStub> {
     ...
     * </pre>
     */
    public     example.Monster showMonster(example.MonsterRequest request)     {
  ...
  public static final class MonsterSvcFutureStub extends io.grpc.stub.AbstractStub<MonsterSvcFutureStub> {
     ...
     * </pre>
     */
    public     com.google.common.util.concurrent.ListenableFuture<example.Monster> showMonster(
        example.MonsterRequest request)     {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SHOW_MONSTER:
          serviceImpl.showMonster((example.MonsterRequest) request,
              (io.grpc.stub.StreamObserver<example.Monster>) responseObserver);
          break;
        default:
